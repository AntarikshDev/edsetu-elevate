...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-primary": "linear-gradient(135deg, hsl(var(--primary)), hsl(var(--indigo-600)))",
        "gradient-accent": "linear-gradient(135deg, hsl(var(--primary)), hsl(var(--accent)))",
        "gradient-radial": "radial-gradient(ellipse at center, var(--tw-gradient-stops))",
        "gradient-hero": "linear-gradient(135deg, hsl(var(--indigo-50)) 0%, hsl(var(--background)) 50%, hsl(225 60% 97%) 100%)",
      },
    },
  },
